...
-- ----------------------------
BEGIN;
INSERT INTO `address` VALUES (7, '广州', 'gdut', '1333333', 2);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cart` VALUES (8, 1, '2024-5-12 17:48:29', 9, '21基础款', 1);
INSERT INTO `cart` VALUES (12, 1, '2024-5-12 18:06:37', 12, '精品猫', 2);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', '管理员', '110238372@qq.com', '13333333333', 'gdut', '/avatar/51c0343a-9f77-4063-abe1-b7543f15fb3c.png', 'admin');
INSERT INTO `sys_user` VALUES (2, 'user', 'e10adc3949ba59abbe56e057f20f883e', '新用户', '726381263@qq.com', '15888888888', 'gdut', '/avatar/6822d648-1c3c-43d7-afc0-25af6250f06a.jpg', 'user');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_order` VALUES (15, '20231112180622711294', 6999.00, 2, '广州', '1333333', 'gdut', '已收货', '2024-5-12 18:06:22');
COMMIT;
